...
public class ShiftEncryption {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File encrypt = encrypt(input, encDir, 5, Charset.forName("UTF-8"));
        File decrypt = decrypt(encrypt, decrDir, 5, Charset.forName("UTF-8"));
    }

    public static File encrypt(File input, File outDir, int shift, Charset charset) throws IOException {
        File outFile = new File(outDir, shift + "_" + input.getName());
